...
function getNodeDeps() {
  const ret = exports0['backstage:plugins/backstage-frontend-plugin#get-node-deps']();
  let variant6;
...
function getComponentFiles() {
  const ret = exports0['backstage:plugins/backstage-frontend-plugin#get-component-files']();
  let variant7;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      var len5 = dataView(memory0).getInt32(ret + 8, true);
...
const $init = (async() => {
  const module0 = base64Compile('');
  ({ exports: exports0 } = await instantiateCore(await module0));
  memory0 = exports0.memory;
})();

await $init;
const backstageFrontendPlugin = {
  getComponentFiles: getComponentFiles,
  getNodeDeps: getNodeDeps,
  
};

export { backstageFrontendPlugin,  }