...
pub mod exports {
    pub mod component {
        pub mod backstage_rust_plugin {
            #[allow(clippy::all)]
            pub mod backstage_backend_plugin {
                #[used]
                #[doc(hidden)]
                #[cfg(target_arch = "wasm32")]
                static __FORCE_SECTION_REF: fn() =
                ...
                pub unsafe fn _export_get_routes_cabi<T: Guest>() -> *mut u8 {
                    let result0 = T::get_routes();
                            ...
                            *ptr1.add(0).cast::<u8>() = (0i32) as u8;
                            ...
                            for (i, e) in vec5.into_iter().enumerate() {
                                let base = result5.add(i * 16);
                                {
                                    ...
                                    let vec3 = (method2.into_bytes()).into_boxed_slice();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_get_routes<T: Guest>(arg0: *mut u8) {
                ...
                pub trait Guest {
                    ...
                    fn get_routes() -> Result<_rt::Vec<Route>, _rt::String>;
                }
                #[doc(hidden)]

                macro_rules! __export_component_backstage_rust_plugin_backstage_backend_plugin_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "component:backstage-rust-plugin/backstage-backend-plugin#get-routes"]
          unsafe extern "C" fn export_get_routes() -> *mut u8 {
            $($path_to_types)*::_export_get_routes_cabi::<$ty>()
          }
          #[export_name = "cabi_post_component:backstage-rust-plugin/backstage-backend-plugin#get-routes"]
          unsafe extern "C" fn _post_return_get_routes(arg0: *mut u8,) {
            $($path_to_types)*::__post_return_get_routes::<$ty>(arg0)
          }
        };);
      }
                #[doc(hidden)]
                pub(crate) use __export_component_backstage_rust_plugin_backstage_backend_plugin_cabi;
                #[repr(align(4))]
...
macro_rules! __export_plugin_impl {
  ...
  $($path_to_types_root)*::exports::component::backstage_rust_plugin::backstage_backend_plugin::__export_component_backstage_rust_plugin_backstage_backend_plugin_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::backstage_rust_plugin::backstage_backend_plugin);
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6459] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xbe1\x01A\x02\x01A\x15\
...
e\x01\x8c\x01\x03\x01\x15wasi:http/types@0.2.0\x05\x09\x01B\x06\x01r\x02\x06meth\
ods\x04paths\x04\0\x05route\x03\0\0\x01p\x01\x01j\x01\x02\x01s\x01@\0\0\x03\x04\0\
\x0aget-routes\x01\x04\x04\x018component:backstage-rust-plugin/backstage-backend\
-plugin\x05\x0a\x02\x03\0\x04\x10incoming-request\x02\x03\0\x04\x11response-outp\
aram\x01B\x08\x02\x03\x02\x01\x0b\x04\0\x10incoming-request\x03\0\0\x02\x03\x02\x01\
\x0c\x04\0\x11response-outparam\x03\0\x02\x01i\x01\x01i\x03\x01@\x02\x07request\x04\
\x0cresponse-out\x05\x01\0\x04\0\x06handle\x01\x06\x04\x01\x20wasi:http/incoming\
-handler@0.2.0\x05\x0d\x04\x01&component:backstage-rust-plugin/plugin\x04\0\x0b\x0c\
